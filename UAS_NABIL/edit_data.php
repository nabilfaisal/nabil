...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $update_query = "UPDATE library SET title = '$new_title', author = '$new_author', published_year = '$new_publish_year', isbn = '$new_isbn' WHERE id = '$id_to_update'";
...
if (isset($_GET['id'])) {
    ...
    $edit_query = "SELECT id, title, author, published_year, isbn FROM library WHERE id = '$id_to_edit'";
...
<head>
    ...
    <style>
        body {
            ...
            background-color: #aad4aa; /* Light Green Background */
            margin: 0;
            padding: 0;
            box-sizing: border-box;
            color: #033e5e; /* Dark Blue Text */
        }

        header {
            background-color: #033e5e; /* Dark Blue Header */
            color: #fff;
            text-align: center;
            padding: 20px;
        }
        ...
        nav {
            background-color: #48a1fc; /* Sky Blue Nav Background */
            overflow: hidden;
        }
        ...
        nav a:hover {
            ...
            color: #033e5e; /* Dark Blue Text on Hover */
        }
        ...
        button {
            background-color: #48a1fc; /* Sky Blue Button */
            color: #fff;
            padding: 10px 15px;
            border: none;
            cursor: pointer;
        ...
        button:hover {
            background-color: #1e7a35; /* Dark Green Button on Hover */
        }
    </style>
</head>
