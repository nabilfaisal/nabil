...
if (isset($_GET['action']) && $_GET['action'] == 'hapus' && isset($_GET['id'])) {
    ...
    $delete_query = "DELETE FROM library WHERE id = '$id_to_delete'";
    $conn->query($delete_query);
}

$query = "SELECT id, title, author, published_year, isbn FROM library";
...
<head>
    ...
    <title>Perpustakaan NABIL</title>
    <style>
        body {
        ...
        th {
            background-color: #1e7a35; /* Dark Green Table Header */
            color: #fff;
        }
